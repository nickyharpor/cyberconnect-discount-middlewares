...
/**
 * @title  Collect First N Middleware
 * @author Nicky Harpor
 * @notice First N collectors get a discount
 */
contract CollectFirstNMw is IEssenceMiddleware, FeeMw {
    ...
    mapping(uint256 => mapping(uint256 => CollectFirstData))
    ...
    function setEssenceMwData(
        ...
        _paidEssenceData[profileId][essenceId].firstN = firstN;
