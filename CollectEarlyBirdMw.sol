...
/**
 * @title  Collect Early Bird Middleware
 * @author Nicky Harpor
 * @notice Early bird collectors get a discount
 */
contract CollectEarlyBirdMw is IEssenceMiddleware, FeeMw {
    ...
    mapping(uint256 => mapping(uint256 => CollectEarlyBirdData))
     ...
     * from the essence collector to the essence owner. Also applies discount if target block has not passed.
     */
    function preProcess(
        uint256 profileId,
        uint256 essenceId,
